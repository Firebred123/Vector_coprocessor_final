...
void Vsoc_top_cv32e40x_if_xif___ctor_var_reset(Vsoc_top_cv32e40x_if_xif* vlSelf);

Vsoc_top_cv32e40x_if_xif::Vsoc_top_cv32e40x_if_xif(const char* _vcname__)
    : VerilatedModule(_vcname__)
 {
    // Reset structure values
    Vsoc_top_cv32e40x_if_xif___ctor_var_reset(this);
}

void Vsoc_top_cv32e40x_if_xif::__Vconfigure(Vsoc_top__Syms* _vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->vlSymsp = _vlSymsp;
}

Vsoc_top_cv32e40x_if_xif::~Vsoc_top_cv32e40x_if_xif() {
}

void Vsoc_top_cv32e40x_if_xif___ctor_var_reset(Vsoc_top_cv32e40x_if_xif* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsoc_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsoc_top_cv32e40x_if_xif___ctor_var_reset\n"); );
    // Body
