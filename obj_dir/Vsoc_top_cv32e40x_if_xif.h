...
#ifndef VERILATED_VSOC_TOP_CV32E40X_IF_XIF_H_
#define VERILATED_VSOC_TOP_CV32E40X_IF_XIF_H_  // guard
...
VL_MODULE(Vsoc_top_cv32e40x_if_xif) {
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vsoc_top_cv32e40x_if_xif);  ///< Copying not allowed
  public:
    Vsoc_top_cv32e40x_if_xif(const char* name);
    ~Vsoc_top_cv32e40x_if_xif();
